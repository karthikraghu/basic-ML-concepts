...
print("1-1")
print("DR: " + format(np.round(DR_xx, 1)))
print("DTheta :" + format(np.round(DTheta_xx, 1)))

print("2-1")
print("DR: " + format(np.round(DR_yx, 1)))
print("DTheta :" + format(np.round(DTheta_yx, 1)))

print("1-2")
print("DR: " + format(np.round(DR_xy, 1)))
print("DTheta :" + format(np.round(DTheta_xy, 1)))

print("1-3")
print("DR: " + format(np.round(DR_xz, 1)))
print("DTheta :" + format(np.round(DTheta_xz, 1)))

print("2-3")
print("DR: " + format(np.round(DR_yz, 1)))
